...
class ClothesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clothe" do
    assert_difference('Clothe.count') do
      post clothes_url, params: { clothe: { content: @clothe.content, title: @clothe.title } }
    end
  ...
  test "should update clothe" do
    patch clothe_url(@clothe), params: { clothe: { content: @clothe.content, title: @clothe.title } }
